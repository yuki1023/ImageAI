//
//  NormalQuizViewController.swift
//  QuizFrench
//
...
class NormalQuizViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let sVC = segue.destination as! NormalScoreViewController
        sVC.correct = correctCount
        
    }
}
extension NormalQuizViewController: AVAudioPlayerDelegate {
    ...
    func showQuiz() {
        ...
        //データストアから読み取る NCMB型
        let query = NCMBQuery(className: "NormalQuiz")
        //絞り込み
