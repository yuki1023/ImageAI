...
class EasyScoreViewController: UIViewController {
    ...
    @IBAction func toTitleButtonAction(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(identifier: "Title") as! ViewController
